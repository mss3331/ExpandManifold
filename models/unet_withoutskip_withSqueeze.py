from models.unet_withoutskip import DownConv, conv1, UpConv, GridAttention, checkpoint
from typing import Sequence, Union, Tuple, Optional
import torch.nn as nn
import torch

class UNet_squeeze(nn.Module):
    ...
    def __init__(
        ...
        self.unsqueezChannels = DownConv(
                1,
                outs,
                pooling=pooling,
                planar=planar,
